"""
Created Mon 18 Jul 2022 03:33:27 PM EAT
...
the list and the smallest odd number in the list.
...
def odd_even(param):
    odds = [x for x in param if x % 2 != 0 ] # list of odd numbers
    evens = [ y for y in param if y %2 == 0] # list of even numbers 
